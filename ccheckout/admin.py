...
class OrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
                ('Generales', {'fields': ('consecutivo', 'base_total','end_total','usd_total','cup_total','cup_oficial','mlc_total','total_reported','coupon_percent', 'others_discount', 'discount', 'currency', 'change_usd_cup')}),
